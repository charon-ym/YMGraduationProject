let sdssds = [{
    "backMenu": [
        ...
        { "child": [{ "appFrontIcon": "cuIcon-album", "buttons": ["新增", "查看", "修改", "删除"], "menu": "党组织信息", "menuJump": "列表", "tableName": "dangzuzhixinxi" }], "menu": "党组织信息管理" },
        { "child": [{ "appFrontIcon": "cuIcon-addressbook", "buttons": ["查看", "修改", "删除", "打印", "学生入党统计", "首页总数", "首页统计", "导出"], "menu": "学生入党", "menuJump": "列表", "tableName": "xueshengrudang" }], "menu": "学生入党管理" },
        { "child": [{ "appFrontIcon": "cuIcon-list", "buttons": ["查看", "修改", "删除", "打印", "首页总数", "首页统计", "教工入党统计", "导出"], "menu": "教工入党", "menuJump": "列表", "tableName": "jiaogongrudang" }], "menu": "教工入党管理" },
    ...
    { "backMenu": [{ "child": [{ "appFrontIcon": "cuIcon-album", "buttons": ["查看", "学生申请"], "menu": "党组织信息", "menuJump": "列表", "tableName": "dangzuzhixinxi" }], "menu": "党组织信息管理" }, 
    ...
    { "backMenu": [{ "child": [{ "appFrontIcon": "cuIcon-album", "buttons": ["查看", "教工入党"], "menu": "党组织信息", "menuJump": "列表", "tableName": "dangzuzhixinxi" }], "menu": "党组织信息管理" }, 
    ...
    { "backMenu": [{ "child": [{ "appFrontIcon": "cuIcon-album", "buttons": ["查看"], "menu": "党组织信息", "menuJump": "列表", "tableName": "dangzuzhixinxi" }], "menu": "党组织信息管理" }, 
        { "child": [{ "appFrontIcon": "cuIcon-addressbook", "buttons": ["查看", "审核"], "menu": "学生入党", "menuJump": "列表", "tableName": "xueshengrudang" }], "menu": "学生入党管理" }, 
        { "child": [{ "appFrontIcon": "cuIcon-list", "buttons": ["查看", "审核"], "menu": "教工入党", "menuJump": "列表", "tableName": "jiaogongrudang" }], "menu": "教工入党管理" },
        { "child": [{ "appFrontIcon": "cuIcon-news", "buttons": ["新增", "查看", "修改", "删除"], "menu": "党建宣传", "tableName": "news" }], "menu": "新闻学习" }],
