			...
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0px 40px 0px","flexWrap":"wrap","background":"none","display":"flex"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"100%","padding":"0px 0 30px","flexWrap":"wrap","background":"linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(255,230,223,.3) 80%, rgba(255,129,93,1) 100%)","justifyContent":"center","display":"flex"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#333","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">教工账号</label>
						<el-input v-model="searchForm.jiaogongzhanghao" placeholder="教工账号" clearable></el-input>
					</div>
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.jiaogongzhanghao!='' && this.searchForm.jiaogongzhanghao!=undefined){
            params['jiaogongzhanghao'] = '%' + this.searchForm.jiaogongzhanghao + '%'
          }
