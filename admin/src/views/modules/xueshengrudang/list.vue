		...
		<template v-if="showFlag">
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' v-if="isAuth('xueshengrudang','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
...
//统计接口
    ...
    async printJson() {
      ...
      for (let i=0; i < this.list.length; i++) {
          ...
          xuexipaiming: this.list[i].xuexipaiming,
