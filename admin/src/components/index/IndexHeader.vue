<template>
	<div class="navbar">
		<div class="title" :style='{"width":"100%","padding":"0 0 0 10px","margin":"0px","position":"absolute","background":"none","height":"100%"}'>
			...
			<span class="title-name" :style='{"padding":"0px","lineHeight":"80px","fontSize":"26px","color":"#fff"}'>{{this.$project.projectName}}</span>
		</div>
		<div class="right" :style='{"padding":"0px 0px 0 40px","top":"5px","background":"none","display":"flex","position":"absolute",right: "50px", "zIndex":"999"}'>
