<template>
	<div class="menu-preview">
		...
		<el-menu
		  :unique-opened="true"
		  :style='{"border":0,"padding":"0px 40px","listStyle":"none","margin":"20px auto 0","position":"relative","background":"rgba(255,255,255,.6)"}'
		  default-active="0"
		...
		>
		  ...
		  <el-submenu :popper-append-to-body="false" index="1">
			<template slot="title">
				<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","display":"none","width":"34px","fontSize":"18px"}' class="el-icon-menu el-icon-user-solid" />
		  ...
		  <el-submenu :popper-append-to-body="false" v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
			<template slot="title">
				<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","display":"none","width":"34px","fontSize":"18px"}' class="el-icon-menu" :class="icons[index]" />
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"1px solid #ddd","padding":"0","margin":"0"}
